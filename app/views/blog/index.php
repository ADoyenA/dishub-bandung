        ...
        <div class="row">
          ...
          <div class="col-lg-4  col-md-6 d-flex align-items-stretch" data-aos="fade-up">
            <article class="entry">
              ...
              <h2 class="entry-title">
                <a href="<?= BASEURL; ?>/blog/blogSingle">Nisi magni odit consequatur autem nulla dolorem</a>
              </h2>
          ...
          <div class="col-lg-4  col-md-6 d-flex align-items-stretch" data-aos="fade-up">
            <article class="entry">
              ...
              <h2 class="entry-title">
                <a href="<?= BASEURL; ?>/blog/blogSingle">Possimus soluta ut id suscipit ea ut. In quo quia et soluta libero sit sint.</a>
              </h2>
          ...
          <div class="col-lg-4  col-md-6 d-flex align-items-stretch" data-aos="fade-up">
            <article class="entry">
              ...
              <h2 class="entry-title">
                <a href="<?= BASEURL; ?>/blog/blogSingle">Non rem rerum nam cum quo minus. Dolor distinctio deleniti explicabo eius exercitationem.</a>
              </h2>
